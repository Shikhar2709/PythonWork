...
def train_prediction_model(df):
    ...
    X = cust_summary[["NumOrders", "AvgOrdersValue"]]
...
if predict_btn:
    input_data = pd.DataFrame(
        {"NumOrders": [input_orders], "AvgOrdersValue": [input_aov]}
    )
...
if "prediction" in st.session_state:
    ...
    comparison_df = cust_summary_full[["CustomerID", "NumOrders", "AvgOrdersValue", "TotalSpent"]].copy()
